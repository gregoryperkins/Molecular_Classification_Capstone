...
[Microarray Introduction Presentation](Microarrays_Introduction.pdf)
...
[Microarray Reliability Presentation](Microarrays_Reliability.pdf)
...
[Muliple Comparisons Presentation](Microarrays_Mulitple_Comparisons.pdf)
...
[PCA Presentation](PCA.pdf)

[clean_data.r](clean_data.r) --> [clean_gene_train_data.csv](clean_gene_train_data.csv) and [clean_gene_test_data.csv](clean_gene_test_data.csv)

[load_data.r](load_data.r)

[pca.r](pca.r) --> [train_principle_components.csv](train_principle_components.csv) and [test_principle_components.csv](test_principle_components.csv)
...
<img src="/images/cluster_4.png" alt="drawing" width="300"/>
...
[generate_cluster_results.r](generate_cluster_results.r)

[Cluster Analysis Presentation](Clustering.pdf)
...
[custom_kmeans.r](custom_kmeans.r)

[k_means_pca_clustering.r](kmeans_pca_clustering.r)

[hierarchical_clustring.r](hierarchical_clustering.r)

[biclustering_test.r](biclustering_test.r)

[test_cluster_results.csv](test_cluster_results.csv)

[train_cluster_results.csv](train_cluster_results.csv)

[Clustering Continued Presentation](Clustering_Continued.pdf)
...
[Selecting Differentially Expressed Genes Presentation](Selecting_DE_Genes.pdf)

[selecting_DE_genes.r](selecting_DE_genes.r)
...
[Selecting Differenentially Expressed Genes Continued Presentation](Selecting_DE_Genes_Continued.pdf)

[selecting_DE_genes.r](selecting_DE_genes.r)

[gene_wise_t_test.r](gene_wise_t_test.r)
...
[Selecting Differentially Expressed Genes: Moderated t-Statistic Presentation](Moderated_t_statistic.pdf)
